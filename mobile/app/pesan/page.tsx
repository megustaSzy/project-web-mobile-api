...
import { CheckCircle } from "lucide-react-native"; // gunakan versi react-native lucide jika ada
...
export default function PesanPage({ route }) {
...
if (!selectedDest) {
return ( <View style={styles.center}> <Text style={styles.title}>🚫 Destinasi tidak ditemukan</Text> <Text style={styles.text}>Silakan kembali ke halaman utama untuk memilih destinasi.</Text> </View>
);
}

return ( <ScrollView contentContainerStyle={styles.container}>
{/* HEADER */} <View style={styles.header}> <Image source={selectedDest.image} style={styles.image} /> <Text style={styles.name}>{selectedDest.name}</Text> <Text style={styles.location}>{selectedDest.location}</Text> <Text style={styles.desc}>{selectedDest.desc}</Text> </View>
