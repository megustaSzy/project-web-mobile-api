...
import { createDestinationSchema, updateDestinationSchema } from "../schemas/destinationSchema";
...
router.post("/", authMiddleware, authorizeRoles("Admin"), upload.single("image"), validate(createDestinationSchema), destinationController.addDestination);
