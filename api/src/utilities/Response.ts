...
export const ResponseData = {
  ...
  created: <T>(
    ...
    res
      ...
      .json({ status: StatusCodes.CREATED, message, data }),
  ...
  badRequest: (
    ...
    res
      ...
      .json({ status: StatusCodes.BAD_REQUEST, message, data }),
  ...
  forbidden: (res: Response, message = "Forbidden"): Response =>
    res
      ...
      .json({ status: StatusCodes.FORBIDDEN, message, data: null }),
  /**
  ...
  notFound: (res: Response, message = "Data not found"): Response =>
    res
      ...
      .json({ status: StatusCodes.NOT_FOUND, message, data: null }),
