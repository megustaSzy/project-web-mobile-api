...
import ValueTable from "@/components/admin/value/ValueTable";
import ValueFormModal from "@/components/admin/value/ValueFormModal";
import ValueDeleteModal from "@/components/admin/value/ValueDeleteModal";
...
export default function ValuePage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const res = await apiFetch<ValueType>("/api/about/value");
