...
export default function CeritaPage() {
  return (
    <section className="relative flex flex-col md:flex-row justify-center items-center min-h-screen overflow-hidden">
      {/* Background gradasi */}
      ...
      <div className="absolute inset-0 opacity-20">
        <Image
          src="/images/tekturgaris.svg" // pastikan path sesuai folder kamu
          alt="Tekstur garis"
          fill
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full px-6 md:px-20 space-y-8 md:space-y-0 md:space-x-10">
        ...
        <div className="w-full md:w-1/2 flex justify-center relative">
          <Image
            src="/images/test.png" // ganti dengan nama file karakter kamu
            alt="Traveler"
            width={400}
            height={400}
