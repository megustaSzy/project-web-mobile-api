        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 justify-center">
          ...
          <div className="flex flex-col items-center">
            <div className="w-48 h-48 rounded-3xl overflow-hidden bg-yellow-400 flex justify-center items-center">
              <img src="/images/faiz.jpg" alt="User 1" className="w-full h-full object-cover" />
            </div>
            <h3 className="mt-4 text-xl font-semibold text-white">M. Arif Alfa’iz</h3>
            <p className="text-gray-300 text-sm">UIUX Design & Frontend Developer</p>
          </div>

          {/* Member 2 */}
          <div className="flex flex-col items-center">
            <div className="w-48 h-48 rounded-3xl overflow-hidden bg-yellow-400 flex justify-center items-center">
              <img src="/images/faiz.jpg" alt="User 2" className="w-full h-full object-cover" />
            </div>
            <h3 className="mt-4 text-xl font-semibold text-white">Fadly Mustofainal A.</h3>
            <p className="text-gray-300 text-sm">UIUX Design & Frontend Developer</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            <div className="w-48 h-48 rounded-3xl overflow-hidden bg-gray-300 flex justify-center items-center">
              <img src="/images/faiz.jpg" alt="User 3" className="w-full h-full object-cover" />
            </div>
            <h3 className="mt-4 text-xl font-semibold text-white">Raditya Ahmad</h3>
